<?php /*a:2:{s:87:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/new/app/admin/view/newlist/update.html";i:1605855848;s:90:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/new/app/admin/view/common/_container.html";i:1593828172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<input type="hidden" name='newlist_id' id='newlist_id' value="<?php echo $info['newlist_id']; ?>" />
			...
			<div class="row">
				...
				<!-- form start -->
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="names" value="<?php echo $info['names']; ?>" name="names" class="form-control" placeholder="请输入新股名称">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">申购代码：</label>
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="code" value="<?php echo $info['code']; ?>" name="code" class="form-control" placeholder="请输入申购代码">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">发行价格：</label>
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="price" value="<?php echo $info['price']; ?>" name="price" class="form-control" placeholder="请输入发行价格">
						</div>
					</div>
