<?php /*a:2:{s:90:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/new/app/admin/view/upload_config/add.html";i:1588777012;s:90:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/new/app/admin/view/common/_container.html";i:1593828172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				...
				<!-- form start -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="thumb_width" value="" name="thumb_width" class="form-control" placeholder="请输入缩放宽度">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="thumb_height" value="" name="thumb_height" class="form-control" placeholder="请输入缩放高度">
							<span class="help-block m-b-none">单位px</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<?php if(!isset($info['thumb_type'])){ $info['thumb_type'] = ''; }; ?>
