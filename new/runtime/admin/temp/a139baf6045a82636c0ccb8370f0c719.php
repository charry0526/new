<?php /*a:2:{s:87:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/news/app/admin/view/newlist/index.html";i:1605855848;s:91:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/news/app/admin/view/common/_container.html";i:1593828172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="ibox-content"> 
				<div class="row row-lg"> 
					<div class="col-sm-12"> 
						<div class="row" id="searchGroup">
							...
							<div class="col-sm-2">
								<div class="input-group">
									...
									<input type="text" autocomplete="off" class="form-control" id="code" placeholder="申购代码" />
								</div>
							</div>
							<div class="col-sm-2">
								<div class="input-group">
						...
						<?php if(in_array('admin/Newlist/add',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="add" class="btn btn-primary button-margin" onclick="CodeGoods.add()">
						<i class="fa fa-plus"></i>&nbsp;添加
						</button>
						<?php endif; if(in_array('admin/Newlist/update',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="update" class="btn btn-success button-margin" onclick="CodeGoods.update()">
						<i class="fa fa-pencil"></i>&nbsp;修改
						</button>
						<?php endif; if(in_array('admin/Newlist/delete',session('admin.nodes')) || session('admin.role_id') == 1): ?>
						<button type="button" id="delete" class="btn btn-danger button-margin" onclick="CodeGoods.delete()">
						<i class="fa fa-trash"></i>&nbsp;删除
						</button>
						<?php endif; if(in_array('admin/Newlist/view',session('admin.nodes')) || session('admin.role_id') == 1): ?>
...
<script>
	...
	CodeGoods.initColumn = function () {
 		return [
 			...
 			{title: '申购代码', field: 'code', visible: true, align: 'center', valign: 'middle',sortable: true},
	...
	CodeGoods.buttonFormatter = function(value,row,index) {
		if(row.newlist_id){
			var str= '';
			<?php if(in_array('admin/Newlist/update',session('admin.nodes')) || session('admin.role_id') == 1): ?>
