<?php /*a:2:{s:82:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/new/app/admin/view/lists/add.html";i:1605857270;s:90:"/www/wwwroot/3.0xingu/xingupeizi/xingu.dxcfd.com/new/app/admin/view/common/_container.html";i:1593828172;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="row">
				...
				<!-- form start -->
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="agent" value="" name="agent" class="form-control" placeholder="请输入所属代理/ID">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">真实姓名：</label>
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="zname" value="" name="zname" class="form-control" placeholder="请输入真实姓名">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="xgname" value="" name="xgname" class="form-control" placeholder="请输入新股名称">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">申购代码：</label>
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="codes" value="" name="codes" class="form-control" placeholder="请输入申购代码">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">申购数量：</label>
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="nums" value="" name="nums" class="form-control" placeholder="请输入申购数量">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">保证金：</label>
						<div class="col-sm-9">
							<input type="text" autocomplete="off" id="bzj" value="" name="bzj" class="form-control" placeholder="请输入保证金">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" autocomplete="off" value="<?php echo date('Y-m-d H:i:s'); ?>" name="mrsj"  placeholder="请输入买入时间" class="form-control" id="mrsj">
						</div>
					</div>
				<!-- form end -->
				</div>
...
CodeInfoDlg.add = function () {
	 ...
	 var ajax = new $ax(Feng.ctxPath + "/Lists/add", function (data) {
	 	if ('00' === data.status) {
